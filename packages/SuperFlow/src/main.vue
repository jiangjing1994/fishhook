...
-->
<template>
  <div ref="flow-canvas" class="super-flow" @contextmenu.prevent.stop="contextmenu">
    <graph-line
...
import { isBool, isFun, arrayReplace } from '../../utils'
import { getOffset, vector } from './utils'
