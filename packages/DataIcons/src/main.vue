    ...
    <el-row :gutter="gutter">
      <template v-for="(item, index) in data">
        <el-col :key="index" :span="span">
          <div
            class="item"
            :style="`background-color:${itemBackgroundColor};margin-bottom: ${gutter}px;`"
          ...
          >
            ...
            >
              <div class="item-icon" :style="{ color: item.color || color }">
                <i :class="item.icon"></i>
              </div>
              <div class="item-info">
                ...
                <span>
                  <KemCountUp
                    ...
                    :value="item.count"
                  ></KemCountUp>
                  <span style="font-size: 14px" :style="{ color: item.titleColor || titleColor }">
                    {{ item.append }}</span
                  >
                </span>
              </div>
